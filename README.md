...
- Screenshot picker that stages the image to local cache, uploads it to a temporary file host, and types a download command into the active terminal session
